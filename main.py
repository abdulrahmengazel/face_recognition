...
class MainApp(ctk.CTk):
    def __init__(self):
        ...
        self.configure(fg_color=settings.UI_COLORS["bg"])
    ...
    def create_header(self):
        ...
        title = ctk.CTkLabel(header_frame, text="Face Recognition System", font=self.header_font,
                             text_color=settings.UI_COLORS["text"])
        title.pack()

        subtitle = ctk.CTkLabel(header_frame, text="Advanced AI-Powered Security",
                                font=ctk.CTkFont(family="Fire Code", size=12), text_color=settings.UI_COLORS["hover"])
        subtitle.pack()
    ...
    def create_settings_card(self):
        ...
        ctk.CTkLabel(card, text="⚙️ System Configuration", font=self.sub_font,
                     text_color=settings.UI_COLORS["text"]).grid(row=0, column=0, columnspan=2, padx=20, pady=(15, 15),
                                                                 sticky="w")

        # Encoding Model
        ctk.CTkLabel(card, text="Encoding Model:", font=self.text_font, text_color=settings.UI_COLORS["text"]).grid(
        ...
        # Detection Model
        ctk.CTkLabel(card, text="Detection Model:", font=self.text_font, text_color=settings.UI_COLORS["text"]).grid(
        ...
        # YOLO Version
        self.yolo_label = ctk.CTkLabel(card, text="YOLO Version:", font=self.text_font,
                                       text_color=settings.UI_COLORS["text"])
        ...
        ctk.CTkLabel(card, text="Sensitivity:", font=self.text_font, text_color=settings.UI_COLORS["text"]).grid(row=4,
                                                                                                                 ...
                                                                                                                 pady=10,
                                                                                                                 sticky="w")
        self.threshold_slider = ctk.CTkSlider(card, from_=0.1, to=1.5, number_of_steps=14,
                                              command=self.update_threshold_label,
                                              button_color=settings.UI_COLORS["button"],
                                              button_hover_color=settings.UI_COLORS["hover"],
    ...
    def create_actions_card(self):
        ...
        ctk.CTkLabel(card, text="🚀 Operations", font=self.sub_font, text_color=settings.UI_COLORS["text"]).grid(row=0,
                                                                                                                column=0,
                                                                                                                columnspan=2,
                                                                                                                padx=20,
                                                                                                                pady=(
    ...
    def create_footer(self):
        ...
        quit_btn = ctk.CTkButton(footer_frame, text="Exit Application", command=self.on_closing,
                                 fg_color=settings.UI_COLORS["danger"], hover_color=settings.UI_COLORS["danger_hover"],
                                 text_color="white")
    ...
    def add_new_person(self):
        ...
        while count < max_images:
            ...
            cv2.putText(frame, f"Capturing: {count + 1}/{max_images}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1,
                        (0, 255, 0), 2)
